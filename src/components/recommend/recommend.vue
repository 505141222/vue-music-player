<template>
  <div class="recommend" ref="recommend">
    <scroll ref="scroll" class="recommend-content"  :data="listData">
      <div>
        ...
        <div class="recommend-list">
          ...
          <ul>
            <li @click="selectItem(item)" class="item" v-for='item in listData'>
              <div class="icon">
      ...
      <div v-if='!listData.length' class="loading-container">
        <loading></loading>
      </div>
    </scroll>
